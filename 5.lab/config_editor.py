...
def save_parameters():
    ...
    with open(config_path, "w") as file:  
        ...
        file.write(f'inertia_weight = {float(inertia_weight_entry.get())}\n')
        file.write(f'cognitive_weight = {float(cognitive_weight_entry.get())}\n')
        file.write(f'social_weight = {float(social_weight_entry.get())}\n')
...
inertia_weight_label = tk.Label(window, text="Inertia weight (float):")
inertia_weight_label.pack()
inertia_weight_entry = tk.Entry(window)
inertia_weight_entry.pack()

cognitive_weight_label = tk.Label(window, text="Cognitive weight (float):")
cognitive_weight_label.pack()
cognitive_weight_entry = tk.Entry(window)
cognitive_weight_entry.pack()

social_weight_label = tk.Label(window, text="Social weight (float):")
social_weight_label.pack()
social_weight_entry = tk.Entry(window)
social_weight_entry.pack()
