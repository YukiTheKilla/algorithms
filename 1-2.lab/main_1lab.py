...
file_path_shop = os.path.join('.', '1-2.lab', 'dict', 'shop.json')
file_path_cathegories = os.path.join('.', '1-2.lab', 'dict', 'cathegories.json')
file_path_brand = os.path.join('.', '1-2.lab', 'dict', 'brand.json')
file_path_card_numbers = os.path.join('.', '1-2.lab', 'dict', 'card_numbers.json')
...
def generate_data():
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=num_threads) as executor:
        ...
        # Save data to XSLX
        output_file_path = r'.\1-2.lab\result\output.xlsx'
        workbook.save(output_file_path)

        # Save data to JSON
        json_output_path = './1-2.lab/result/output.json'
